...
export const VIP_PACKAGES: BoostPackage[] = [
  ...
  },
  {
    ...
    type: "vip",
    nameAz: "VIP — 30 gün",
    descriptionAz: "30 gün tam VIP blok — tam elan müddəti boyunca görünürlük.",
    priceAzn: 40,
    durationDays: 30,
    bumpsPerDay: 1,
    includedBonuses: ["Hər gün 1 dəfə irəli çək"]
...
export const PREMIUM_PACKAGES: BoostPackage[] = [
  ...
  },
  {
    ...
    descriptionAz: "15 gün ən yüksək görünürlük.",
    priceAzn: 45,
    durationDays: 15,
    bumpsPerDay: 1,
  ...
  },
  {
    ...
    descriptionAz: "30 gün ana səhifə + VIP + irəli çək — maksimum görünürlük.",
    priceAzn: 60,
    durationDays: 30,
    bumpsPerDay: 1,
