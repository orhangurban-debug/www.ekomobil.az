      ...
      <div className="rounded-2xl border border-white/10 card p-8 shadow-sm">
        ...
        <dl className="grid gap-4 rounded-xl bg-white/5 p-4 text-sm sm:grid-cols-2">
          ...
          <div>
            ...
            <dd className="mt-1 font-medium text-white">{getStatusLabel(payment.status)}</dd>
          </div>
          <div>
          ...
          <div>
            <dt className="text-white/50">Növ</dt>
            <dd className="mt-1 font-medium text-white">{getEventLabel(payment.eventType)}</dd>
          </div>
          <div>
