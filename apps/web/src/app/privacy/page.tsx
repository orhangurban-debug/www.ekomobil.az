        ...
        <tbody className="divide-y divide-slate-900/10">
          {rows.map((row) => (
            <tr key={row.category} className="align-top">
              <td className="px-4 py-3 font-medium text-slate-900 whitespace-nowrap">{row.category}</td>
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12">
          ...
          <Section id="use" title="2. Məlumatları necə istifadə edirik?">
            ...
            <p className="rounded-lg bg-white/60 border border-slate-900/10 px-4 py-3 text-sm">
          ...
          <Section id="sharing" title="4. Məlumatları kimlərlə paylaşırıq?">
            ...
            <div className="mt-3 space-y-3">
              {[
                ...
                <div key={item.who} className="rounded-lg border border-slate-900/10 px-4 py-3 text-sm">
                  <p className="font-medium text-slate-900">{item.who}</p>
                ...
                <tbody className="divide-y divide-slate-900/10">
                  {[
                    ...
                    <tr key={row.type}>
                      ...
                      <td className="px-4 py-3 font-medium text-slate-900">{row.duration}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
              ...
              {[
                {
                  ...
                  badge: "bg-white/63 text-slate-700"
                },
                {
                ...
                <div key={item.type} className="flex items-start gap-3 rounded-lg border border-slate-900/10 px-4 py-3">
