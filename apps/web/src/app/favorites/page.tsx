  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white">Favorilər</h1>
          <p className="mt-2 text-white/50">{items.length} elan saxlanılıb</p>
        </div>
      ...
      {items.length === 0 ? (
        <div className="card p-10 text-center">
          <h2 className="font-semibold text-white">Favorilər boşdur</h2>
          <p className="mt-2 text-sm text-white/50">Bəyəndiyiniz elanları saxlayın ki, sonra asan tapa biləsiniz.</p>
