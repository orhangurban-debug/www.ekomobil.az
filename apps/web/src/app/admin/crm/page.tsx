    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Sorğu statusları, cavab SLA metrikası və müştəri əlaqələrinin mərkəzi görünüşü.
        </p>
      </div>

      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-4"><p className="text-xs text-slate-500">Cəmi sorğu</p><p className="text-2xl font-bold">{snapshot.totalLeads}</p></div>
