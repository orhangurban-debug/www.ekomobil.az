  ...
  return (
    <div className="mt-5 flex flex-wrap gap-3">
      <a
        ...
        className="inline-flex items-center gap-2 rounded-xl bg-[#0057FF] px-5 py-2.5 text-sm font-medium text-white transition hover:bg-[#0057FF]/90"
      >
      ...
      <a
        ...
        rel="noreferrer"
        onClick={() => trackServiceContactClick(slug)}
        className="inline-flex items-center gap-2 rounded-xl border border-emerald-500/25 bg-emerald-500/10 px-5 py-2.5 text-sm font-medium text-emerald-700 transition hover:bg-emerald-500/20"
      >
